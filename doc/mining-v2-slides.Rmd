...
![Image of Children's Mercy Hospital, Adele Hall Campus](images/cmh-resized.png)
...
![Cleveland Chiropractic College campus](images/cleveland-resized.png)
...
![North Kansas City Hospital](images/nkc-hospital-resized.png)
...
... but my two favorite backyards are UMKC and KUMC. I'm half Kangaroo and half Jayhawk.
...
So when this guy offered me a chance to work at KU Med Center in Medical Informatics, I said "Heck yes!" Now they hated me at UMKC for this. I had child care commitments and so to find the time to work with Russ I had to drop some really good things at UMKC. But I had to do this, because Medical Informatics is just like Statistics. They also get to play in everyone's backyard.
...
Now, what I've shown you so far isn't too fancy, but there's someone else in Medical Informatics, Mei Liu, who is a lot smarter than me, and she has several research publications on Acute Kidney Injury, A big NSF grant, and a PostDoc working with her.
...
So if you want to work in this area that I call "Mining the electronic health record" you need four things. You need to have a working knowledge of SQL. You also have to be pretty good at data wrangling. Data wrangling is a term that some guy, I'm sure it was a guy, developed to make the term data management sound more macho.
...
If you want to work in this area. We have scheduled an informatics meetup on May 23. We'll have speakers from the beginner's intermediate, and advanced spectrum of data mining. Mei Liu and I will be there along with a bunch of others in Russ's department. If you've got an interesting backyard, we want you to be there, too.
